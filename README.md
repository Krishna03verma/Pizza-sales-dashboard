...
* Tracks order trends across time (hourly & monthly)
* Evaluates delivery performance under different traffic conditions
* Identifies delays and inefficiencies in operations
* Compares restaurant performance for better decision-making
...
* **Order Trends:** Monthly & Hourly
* **Delivery Delay Metrics:** Per order delay analysis

*(Derived from dashboard visuals in project file)* 
...
* Standardized categorical variables (Pizza Type, Restaurant Names)
...
* `Pizza Sales Dashboard.pdf` → Dashboard preview
...
3. Analyze trends and delivery performance
4. Identify insights for business improvement
...
* Build Power BI version with advanced visuals
* Add revenue & profit analysis
